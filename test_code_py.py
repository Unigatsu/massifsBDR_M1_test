...
with st.sidebar:
    ...
    st.markdown("2. Assurez-vous que les URL GitHub vers vos fichiers zippés sont correctes (avec `?raw=true`).")
    ...
    try:
        ...
        with zipfile.ZipFile(io.BytesIO(response.content)) as zf:
            ...
            if not shp_files:
                ...
                return None
            shp_file = shp_files[0]  # Prendre le premier fichier .shp trouvé
...
url_massifs = "https://github.com/Unigatsu/massifsBDR_M1_test/blob/567dd868905ab7ffde26ef9594f804d445835945/massifs_13_mrs_true.zip?raw=true"
url_vegetation = "https://github.com/Unigatsu/massifsBDR_M1_test/blob/8b89379371c3d935c367d0ecbd070a40092c85d8/veg_massifs_mrs_true.zip?raw=true"
...
if selected_massif_id:
    ...
    if not vegetation_massif.empty:
        ...
        if colonne_type_vegetation in vegetation_massif.columns:
            ...
            vegetation_counts = vegetation_massif[colonne_type_vegetation].value_counts().sort_values(ascending=False).head(10)
